<table>
    ...
    <tr>
        ...
        <td>Responder automaticamente a mensagens básicas indicando que a mensagem foi recebida. Padrão: falso.</td>
    </tr>
    <tr>
...
Debug:
  ...
  --auto-accept-requests
                        ...
                        Default: false. [env var: ACAPY_AUTO_ACCEPT_REQUESTS]
...
Mediation:
  ...
  --auto-send-keylist-update-in-requests
                        Automatically updated mediator with newly created
                        keys. keylists. Default: false. [env var:
                        ACAPY_AUTO_SEND_KEYLIST_UPDATE_IN_REQUESTS]
  --auto-send-keylist-update-in-create-invitation
                        Automatically updated mediator with newly created
                        keys. keylists. Default: false. [env var:
                        ACAPY_AUTO_SEND_KEYLIST_UPDATE_IN_CREATE_INVITATION]
