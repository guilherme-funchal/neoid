...
**Exemplo :**
<pre>
curl -X POST "http://172.17.0.1:8021/present-proof/send-request" -H "accept: application/json" -H "Content-Type: application/json" -d "{ \"connection_id\": \"6f0adf7c-91b7-4488-b97b-f38f42409ca5\", \"comment\": \"This is a comment about the reason for the proof\", \"proof_request\": { \"name\": \"Proof of Education\", \"version\": \"1.0\", \"requested_attributes\": { \"0_name_uuid\": { \"name\": \"name\", \"restrictions\": [ { \"cred_def_id\": \"6NhFfZyVx7dAyhrgL49yJq:3:CL:179:Faber.initial.degree_schema\" } ] }, \"0_date_uuid\": { \"name\": \"date\", \"restrictions\": [ { \"cred_def_id\": \"6NhFfZyVx7dAyhrgL49yJq:3:CL:179:Faber.initial.degree_schema\" } ] }, \"0_degree_uuid\": { \"name\": \"degree\", \"restrictions\": [ { \"cred_def_id\": \"6NhFfZyVx7dAyhrgL49yJq:3:CL:179:Faber.initial.degree_schema\" } ] }, \"0_self_attested_thing_uuid\": { \"name\": \"self_attested_thing\" } }, \"requested_predicates\": { \"0_age_GE_uuid\": { \"name\": \"age\", \"p_type\": \">=\", \"p_value\": 18, \"restrictions\": [ { \"cred_def_id\": \"6NhFfZyVx7dAyhrgL49yJq:3:CL:179:Faber.initial.degree_schema\" } ] } } }}" -H "accept: application/json" -H "Authorization: Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ3YWxsZXRfaWQiOiI3ZTU3ZWM4MC0wZmJhLTQ3MjMtOWY4Zi1iOGQ2YmNiMDY5OTgifQ.L1U2cEYPZ4s4jyHMIDhbiktB0J-kKH61VDKX2JEio3M"
</pre>

**Resposta :**

<pre>
{"results": [{"invitation_key": "GUVEc6yUWsVdRrvkP5dw2BYDAp4uurGx5xWsws6cBja5", "state": "active", "connection_id": "6f0adf7c-91b7-4488-b97b-f38f42409ca5", "their_did": "G5QZu1jdsc39a6ryNLFM93", "routing_state": "none", "accept": "auto", "their_label": "Alice.Agent", "invitation_mode": "once", "created_at": "2021-01-15 18:17:37.072957Z", "my_did": "PLBD7oa58Kbipk4A97Qmre", "updated_at": "2021-01-15 18:17:49.622295Z", "their_role": "invitee"}]}root@ThinkPad-X240:/home/funchal/git/von-network# curl -X POST "http://172.17.0.1:8021/present-proof/send-request" -H "accept: application/json" -H "Content-Type: application/json" -d "{ \"connection_id\": \"6f0adf7c-91b7-4488-b97b-f38f42409ca5\", \"comment\": \"This is a comment about the reason for the proof\", \"proof_request\": { \"name\": \"Proof of Education\", \"version\": \"1.0\", \"requested_attributes\": { \"0_name_uuid\": { \"name\": \"name\", \"restrictions\": [ { \"cred_def_id\": \"6NhFfZyVx7dAyhrgL49yJq:3:CL:179:Faber.initial.degree_schema\" } ] }, \"0_date_uuid\": { \"name\": \"date\", \"restrictions\": [ { \"cred_def_id\": \"6NhFfZyVx7dAyhrgL49yJq:3:CL:179:Faber.initial.degree_schema\" } ] }, \"0_degree_uuid\": { \"name\": \"degree\", \"restrictions\": [ { \"cred_def_id\": \"6NhFfZyVx7dAyhrgL49yJq:3:CL:179:Faber.initial.degree_schema\" } ] }, \"0_self_attested_thing_uuid\": { \"name\": \"self_attested_thing\" } }, \"requested_predicates\": { \"0_age_GE_uuid\": { \"name\": \"age\", \"p_type\": \">=\", \"p_value\": 18, \"restrictions\": [ { \"cred_def_id\": \"6NhFfZyVx7dAyhrgL49yJq:3:CL:179:Faber.initial.degree_schema\" } ] } } }}" -H "accept: application/json" -H "Authorization: Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ3YWxsZXRfaWQiOiI3ZTU3ZWM4MC0wZmJhLTQ3MjMtOWY4Zi1iOGQ2YmNiMDY5OTgifQ.L1U2cEYPZ4s4jyHMIDhbiktB0J-kKH61VDKX2JEio3M"
{"presentation_request_dict": {"@type": "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/present-proof/1.0/request-presentation", "@id": "58f703c1-fee7-4e00-a4cf-b1ac16e1990f", "comment": "This is a comment about the reason for the proof", "request_presentations~attach": [{"@id": "libindy-request-presentation-0", "mime-type": "application/json", "data": {"base64": ""}}]}, "presentation_exchange_id": "257344f4-94e1-438e-9e34-a8977987b4ff", "initiator": "self", "state": "request_sent", "connection_id": "6f0adf7c-91b7-4488-b97b-f38f42409ca5", "trace": false, "created_at": "2021-01-15 19:52:22.850925Z", "presentation_request": {"name": "Proof of Education", "version": "1.0", "requested_attributes": {"0_name_uuid": {"name": "name", "restrictions": [{"cred_def_id": "6NhFfZyVx7dAyhrgL49yJq:3:CL:179:Faber.initial.degree_schema"}]}, "0_date_uuid": {"name": "date", "restrictions": [{"cred_def_id": "6NhFfZyVx7dAyhrgL49yJq:3:CL:179:Faber.initial.degree_schema"}]}, "0_degree_uuid": {"name": "degree", "restrictions": [{"cred_def_id": "6NhFfZyVx7dAyhrgL49yJq:3:CL:179:Faber.initial.degree_schema"}]}, "0_self_attested_thing_uuid": {"name": "self_attested_thing"}}, "requested_predicates": {"0_age_GE_uuid": {"name": "age", "p_type": ">=", "p_value": 18, "restrictions": [{"cred_def_id": "6NhFfZyVx7dAyhrgL49yJq:3:CL:179:Faber.initial.degree_schema"}]}}, "nonce": "797913883682543778010110"}, "auto_present": false, "updated_at": "2021-01-15 19:52:22.850925Z", "role": "verifier", "thread_id": "58f703c1-fee7-4e00-a4cf-b1ac16e1990f"}
</pre>
