...
class IndyProofRequest(models.Model):
    proof_req_name = models.CharField(max_length=400)
    ...
    agent = models.TextField(max_length=400, blank=True)
    schema = models.TextField(max_length=400, blank=True)
    ...
    def __str__(self):
        return self.proof_req_name + ":" + self.agent
