...
class BaseSignUpForm(UserCreationForm):
    ...
    date_birth = forms.CharField(max_length=50, label=trans('Date of birth'), required=False,
                                 help_text='Optional.')
    cpf = forms.CharField(max_length=50, label=trans('CPF'), required=False,
                                 help_text='Optional.')
...
class UserUpdateForm(AgentNameForm):
    ...
    date_birth = forms.CharField(max_length=150, label=trans('Date of birth'), required=False,
                                 help_text='Optional.')
    cpf = forms.CharField(max_length=150, label=trans('CPF'), required=False,
                                 help_text='Optional.')
    ...
    def __init__(self, *args, **kwargs):
        ...
        if initial:
            ...
            self.fields['cpf'].initial = filters[0]['cpf']
