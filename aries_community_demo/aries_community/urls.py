...
urlpatterns = [
    ...
    path('list_connections_org/', list_connections_org, name='list_connections_org'),
    ...
    path('credential_import/', handle_credential_import, name='credential_import'),
    ...
    path('view_proof_sent/', handle_view_proof_sent, name='view_proof_sent'),
    path('view_credential/', handle_view_credential, name='view_credential'),
    ...
    path('proofs/', handle_proofs, name='proofs'),
    path('remove_proof/', handle_proof_remove, name='remove_proof'),
    path('state_proof/', handle_proof_state, name='state_proof'),
